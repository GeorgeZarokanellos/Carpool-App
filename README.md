...
Reduce the number of personal cars carrying only one passenger while simultaneously reducing overcrowding on public buses. 


🛠️ Technologies Used

Frontend: React, Ionic, SCSS
...
Trip participants rating system

Reward points and incentive coupons system
